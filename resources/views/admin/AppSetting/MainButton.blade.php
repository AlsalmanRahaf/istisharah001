    ...
    <div class="col-md-12">
        <div class="tile">
            @foreach($Buttons as $Button)
                <form method="post" action="{{route("admin.App-Setting.UpdateButton",["id"=>$Button->id,"redirect"=>"admin.App-Setting.showMainButton"])}}" enctype="multipart/form-data">
                    @csrf
                    @method("put")
                    <div class="offset-2 col-8 tile-body btn btn-primary mb-5 border border-white" style="border-radius: 12px">
                           <div class="row  m-5 ">
                             <div class="row">
                                 <div class="col-6 ">
                               <div class="form-group">
                                 ...
                                 <div class="col-6 ">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control " type="text" name="description_en" placeholder="{{$Button->description_en}}">
                                   </div>
                            </div>
                                 <div class="col-6 ">
                                     <div class="form-group">
                                 ...
                                 <div class="col-6 ">
                                     <div class="form-group">
                                         ...
                                         <input class="form-control " type="text" name="description_ar" placeholder="{{$Button->description_ar}}">
                                     </div>
                                 </div>
                             </div>
                           </div>
