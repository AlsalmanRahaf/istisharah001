                                        ...
                                        <div class="form-group">
                                            <div class="toggle-flip">
                                                <label class="change-status">
                                                    <input  type="checkbox" name="status" data-userid="{{$room->id}}" data-status="{{$room->status}}" {{ checked("status", 1, $room)}}><span class="flip-indecator" data-toggle-on="{{__("ON")}}" data-toggle-off="{{__("OFF")}}"></span>
                                                </label>
                                            </div>
                                        </div>
                                    </td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                       @foreach($room->room_members as $member)
                                                           <span class="field-view">{{$member->users->phone_number}}</span>
                                                       @endforeach
                                                </div>
                                            </div>
                                        </div>
                                                                                        ...
                                                                                        <div class="message other-message  @if($ch["direction"] != null && $ch["direction"] == "sender") float-right @endif">
                                                                                            ...
                                                                                            @elseif($ch["type"]==2)
                                                                                                @if(count($ch["media"]) > 0)
                                                                                                   @switch($ch["media"][0][1])
                                                                                                       @case(2)
                                                                                                       <img class="img-style"  src="{{$ch["media"][0][0]}}" width="200" height="200" alt="avatar">
                                                                                                       @break
                                                                                                       @case(3)
