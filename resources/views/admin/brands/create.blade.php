                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @if($errors->has('name_en')) is-invalid @endif" type="text" name="name_en" placeholder="Enter English Brand name" value="{{inputValue("name_en")}}">
                                </div>
                                @error("name_en")
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @if($errors->has('name_ar')) is-invalid @endif" type="text" name="name_ar" placeholder="Enter Arabic Brand name" value="{{inputValue("name_ar")}}">
                                </div>
                                @error("name_ar")
                                <div class="input-error">{{$message}}</div>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @if($errors->has('description_en')) is-invalid @endif" name="description_en" cols="30" rows="10" placeholder="{{__("Enter English Description")}}">{{inputValue("description_en")}}</textarea>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @if($errors->has('description_ar')) is-invalid @endif" name="description_ar" cols="30" rows="10" placeholder="{{__("Enter Arabic Description")}}">{{inputValue("description_ar")}}</textarea>
                                </div>
