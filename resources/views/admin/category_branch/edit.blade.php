...
@section("content")
    <div class="row">
        <div class="col-lg-10 m-auto">
            <div class="tile">
                <h3 class="tile-title">{{__("Edit Category Branch")}}</h3>
                <div class="tile-body">
                    <form method="post" action="{{route("admin.category_branch.update", $category->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method("put")
                        <div class="row">
                            <div class="col-lg-6">
