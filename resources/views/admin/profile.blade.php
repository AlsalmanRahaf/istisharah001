...
@section("content")
    ...
    <div class="row">
        <div class="col-lg-10 m-auto">
            <div class="tile">
                <a href="{{ route("admin.profile.index") }}" style="float: right;" class="btn btn-rounded btn-dark mb-5">
                    {{__('Back')}}</a>
                <h3 class="tile-title">Edit Profile</h3>
                <div class="tile-body">
                    <form method="post" action="{{route("admin.admins.profile.save")}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
